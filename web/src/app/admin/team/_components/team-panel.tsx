...
export function TeamPanel({
    ...
    ? {
        ...
        body:
          pendingRemove.role === "admin"
            ...
            : "Su token CLI deja de validar; sus prompts seguirÃ¡n pasando por ArkivGate con el rol default de la org pero ya no quedan atribuidos a esta cuenta.",
  ...
  const cliCommand = `npx ArkivGate setup --org-id ${orgId}`;
...
// Keeps the admin shell within the brand palette per identidad/design.md Â§ 6.
...
function CliInviteCard({
  ...
  return (
    ...
    >
      ...
      <p className="font-mono text-[11px] leading-relaxed text-graphite">
        // si el dev nunca corriÃ³ el comando con --org-id y no fue invitado por
