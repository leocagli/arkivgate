...
export const NAV_ITEMS = [
  { href: "/admin", label: "home", caption: "overview", exact: true },
  { href: "/admin/events", label: "events", caption: "what happened" },
  { href: "/admin/api-keys", label: "api keys", caption: "connect clients" },
  { href: "/admin/rules", label: "rules", caption: "what it controls" },
  { href: "/admin/arkiv", label: "arkiv", caption: "on-chain evidence" },
  { href: "/admin/suggestions", label: "suggestions", caption: "approval queue" },
  { href: "/admin/analytics", label: "analytics", caption: "metrics" },
  { href: "/admin/team", label: "team", caption: "who passes" },
] as const;
