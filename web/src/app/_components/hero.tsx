...
// identidad/design.md Â§ 3, "Comments tipo cÃ³digo"), not stray JS comments.
...
const REPO_URL = "https://github.com/arkivgate/arkivgate";
...
function HeroHeadline() {
  return (
    <motion.h1
      ...
      initial="hidden"
      animate="visible"
      aria-label="arkivgate. un paso controlado."
      className="flex flex-col"
    >
...
function HeroSub() {
  return (
    ...
    >
      ...
      contexto organizacional por defecto â€” con ArkivGate, siempre lo tienen.
    </motion.p>
  );
}
...
function HeroLiveBar() {
  return (
    <motion.div
      ...
      style={{ borderRadius: "var(--radius)" }}
    >
      <LiveStat label="trace Â· last" value="01HXYZKâ€¦" mono />
      <LiveStat label="p95 Â· cascade" value="9 ms" />
      <LiveStat label="verdicts Â· today" countTo={1247} />
      <LiveStat label="rules Â· active" countTo={42} />
    </motion.div>
  );
}
...
// Tiny easing-based counter â€” no extra lib. Counts up once on mount.
